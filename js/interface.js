$(document).ready(function(){
	...
	$(".go-place").bind('tap', function(event){
		game.board.setOnEl($(this));
	});
	
	$('#mode-select input[type="radio"]').bind('change', function(){
		gameData.mode=$(this).val();
	});
	
	$('#color-select input[type="radio"]').bind('change', function(){
		gameData.color=$(this).val();
	});
	
	$('#level-select input[type="radio"]').bind('change', function(){
		gameData.level=$(this).val();
	});
	
	$('.back-to-game').bind('tap',function(){
